...
export default function Career() {
  ...
  const handleFileChange = async (e) => {
    ...
    reader.onload = () => {
      ...
      setResumeData(typeof result === "string" ? result : "");
    };
  ...
  return (
    <div className="py-20 px-6 md:px-20 bg-gray-100">
      ...
      {success ? <Alert severity="success" className="mt-6 max-w-3xl mx-auto">{success}</Alert> : null}
      {error ? <Alert severity="error" className="mt-6 max-w-3xl mx-auto">{error}</Alert> : null}
      ...
      <Dialog open={open} onClose={() => setOpen(false)} fullWidth maxWidth="sm">
        ...
        <DialogContent dividers>
          <div className="flex flex-col gap-4 py-2">
            ...
            {resume ? <p className="text-sm text-green-600">✓ {resume.name}</p> : null}
